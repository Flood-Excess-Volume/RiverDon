...
ax.XTick = [-1:1/h_max:-1/h_max 1/dur:1/dur:1];
ax.YTick = [-1:1/dur:-1/dur 50/q_max:50/q_max:1];
% ax.XTickLabel = [h_max:-1:1 t_min:1:t_max];
% ax.YTickLabel = [t_max:-1:t_min+1 0:50:q_max];
ax.XTickLabel = [h_max:-1:1 t_min+1:1:t_max];
ax.YTickLabel = [t_max:-1:t_min+1 50:50:q_max];
ax.TickDir ='both';
ax.XLim = [-1.1 1.1];
ax.YLim = [-1.1 1.1];
